...
class Player(GameSprite):
 #the method in which the sprite is controlled by the arrow keys of the keyboard
    ...
    def fire(self):
        bullet = Bullet("D:\VSCODE LABIRIN\Bullet.jpeg", self.rect.right, self.rect.centery, 15, 20, 15)
        bullets.add(bullet)
...
w1 = GameSprite("assets/walls.jpeg",win_width / 2 - win_width / 3, win_height / 2, 300, 50)
w2 = GameSprite("assets/walls horizontal.jpeg", 370, 100, 50, 400)
...
#creating sprites
packman = Player('assets/hero.png', 5, win_height - 80, 80, 80, 0, 0)
final_sprite = GameSprite("assets/monster.jpeg", win_width - 85, win_height - 100, 80, 80)


monster1 = Enemy("assets/final sprite.jpeg", win_width - 80, 150, 80, 80, 5)
monster2 = Enemy("assets/final sprite.jpeg", win_width - 80, 230, 80, 80, 5)
...
#checking that the game is not finished yet
 if not finish:
     ...
     if sprite.spritecollide(packman, monsters, False):
         finish = True
         #calculate the ratio
         img = image.load("assets/game over.jpeg")
     ...
     if sprite.collide_rect(packman, final_sprite):
         finish = True
         img = image.load("assets/thumbs up.jpeg")
         window.fill((255, 255, 255))
         window.blit(transform.scale(img, (win_width, win_height)), (0, 0))
 display.update()

#pyinstaller --onefile --add-data "assets;assets" labirint_finish.py